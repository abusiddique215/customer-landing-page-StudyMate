...
const Hero = () => {
  return (
    <section className="pt-32 pb-16 container-padding bg-gradient-to-br from-[#8B5CF6] to-[#6D28D9] text-white">
      ...
      <div className="mt-16 bg-white/10 backdrop-blur-sm rounded-2xl p-4 max-w-4xl mx-auto animate-float">
        <img 
